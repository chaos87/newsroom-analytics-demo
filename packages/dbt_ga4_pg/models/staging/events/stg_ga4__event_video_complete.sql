-- Defined as when the video ends. For embedded YouTube videos that have JS API
-- support enabled. Collected by default via enhanced measurement.
-- (Port fix: upstream had a 'vide_title' typo — corrected to 'video_title'.)
